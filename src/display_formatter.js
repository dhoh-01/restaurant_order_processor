...
export function order_processor() {
	...
	rl.on("line", (line) => {
		...
		let category  = order_item.get_category_by_name(input);
		if (typeof category == 'undefined') {
			...
			let rs_cat = order_item.get_items_for_categories(input);
